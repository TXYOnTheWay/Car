...
#dizhi = unichr(raw_input('输入需要转换的文件地址：'))
#name = unichr(raw_input('请设定输出文件名：'))
try:
    reload(sys)
...
if __name__ == '__main__':
    ...
    # 将要转换的词库添加在这里就可以了
    o = [u'/Users/hughli/Documents/学习/共享/OneDrive/项目/质量协会/汽车频道专用词库.scel',]
